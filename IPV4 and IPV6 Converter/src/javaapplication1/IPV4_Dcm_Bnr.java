 ...
 */
public class IPV4_Dcm_Bnr extends javax.swing.JFrame {

    /**
     * Creates new form IPV4_Dcm_Bnr
     */
    public IPV4_Dcm_Bnr() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Decimal --> Binário");
    ...
    private void bt_avancarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_avancarActionPerformed
        ...
        for(i=0;i<4;i++){
            ...
            if(vn[i]>255)verif = false;
        }
        
        if(ipv4.length()>15||ipv4.length()<7)verif = false;
        ...
        if(!verif){
            ...
            for(i=0;i<4;i++){
                ...
                for(j=0;j<8;j++){
                    str+=Integer.toString(vt[i][j]);
                }
                if(i==3)jLabel5.setText(str+"\n");
                else jLabel5.setText(str+".");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IPV4_Dcm_Bnr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
