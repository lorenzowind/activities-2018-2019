 ...
 */
public class IPV6_Dcm_Hex extends javax.swing.JFrame {

    /**
     * Creates new form IPV6_Dcm_Hex
     */
    public IPV6_Dcm_Hex() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Decimal --> Hexadecimal");
        ...
        for(i=0;i<ipv6.length()-1;i++){
            ...
            if(ipv6.charAt(i)!=':'){
                ...
                if(str != ""){
                    ...
                    if(aux>65535)verif = false;
                    str = "";
                }
            }
        }
        if(ipv6.charAt(ipv6.length()-2)==':'&&ipv6.charAt(ipv6.length()-1)==':'&&a>1)verif = false;
        else if(ipv6.charAt(ipv6.length()-1)!=':'){
            str += ipv6.charAt(ipv6.length()-1);
            aux = Integer.parseInt(str);
            if(aux>65535)verif = false;
        }
        if(a>1)verif = false;
        
        if(ipv6.length()>47||ipv6.length()<3)verif = false;
        ...
        if(!verif){
            ...
            for(i=0;i<ipv6.length();i++){
                ...
                if(ipv6.charAt(i)!=':'){
                    ...
                    if(ipv6.charAt(i-1)!=':'){
                        aux = Integer.parseInt(str);
                        newipv6 += Integer.toHexString(aux).toUpperCase();
                    }
                    newipv6 += ':';
                    str = "";
                    aux=0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IPV6_Dcm_Hex.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
